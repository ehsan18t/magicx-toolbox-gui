...
| [Activate the Ultimate Performance power plan](performance.md#activate-the-ultimate-performance-power-plan) | `ultimate_performance_power_plan` | Performance & Gaming tweaks | Switch (2 options) | medium | admin | no | INCORRECT (corrected form ships) |
...
| [Disable RAM memory compression](performance.md#disable-ram-memory-compression) | `disable_memory_compression` | Performance & Gaming tweaks | Switch (2 options) | medium | admin | yes | VERIFIED-WITH-CORRECTION |
...
| [Turn off reserved storage](performance.md#turn-off-reserved-storage) | `reserved_storage_off` | Performance & Gaming tweaks | Switch (2 options) | medium | admin | no | VERIFIED |
